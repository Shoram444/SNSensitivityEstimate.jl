...
BkgActivityParams = Dict( #activities from Table 1 from 10.1140/epjc/s10052-018-6295-x and docDB 4505
    ...
    :Bi214_PMT_glass_bulk => 0.34,        # [Bq/PMT] from 4263-v1 8'' PMT
    :Bi214_PMT5_glass_bulk => 0.24,        # [Bq/PMT] from 4263-v1 5'' PMT
    :Tl208_foil_bulk => 2 / 1_000_000,                # [Bq/kg] from SN target
    :Tl208_foil_surface => 150 / 1_000_000 ,                  # [Bq/m3] from SN target; gas volume 15m3
    :Tl208_PMT_glass_bulk => 0.26 ,               # [Bq/PMT] from 4263-v1 8'' PMT
    :Tl208_PMT5_glass_bulk => 0.039 ,               # [Bq/PMT] from 4263-v1 5'' PMT
    ...
    :K40_PMT_glass_bulk => 0.95 ,                  # [Bq/PMT] from 4263-v1 8'' PMT
    :K40_PMT5_glass_bulk => 0.53 ,                  # [Bq/PMT] from 4263-v1 5'' PMT
    ...
    :Tl208_hall_bulk => 2.4,         # Xalbat's 2.4 Bq --> neutrino poster
    :K40_hall_bulk => 1.2,         # Xalbat's 1.2 Bq --> neutrino poster
    :Bi214_hall_bulk => 0.5,         # Xalbat's 0.5 Bq --> neutrino poster
